...
--
-- Servidor: localhost
-- Tiempo de generación: 11-06-2024 a las 19:26:10
...
(21, 1, '0888-08-08 00:00:00', '0008-08-08 00:00:00', '88', 'simple', NULL);
...
INSERT INTO `detalle_actividad` (`id`, `fecha_hora_ini`, `fecha_hora_fin`, `titulo`, `detalle_actividad_espacios_id`, `detalle_actividad_evento_id`, `url`, `descripcion`, `id_padre`) VALUES
(29, '0009-09-09 00:00:00', '0009-09-09 00:00:00', 'p', NULL, 2, NULL, 'j', 16),
(30, '0009-09-09 00:00:00', '0009-09-09 00:00:00', 'p', NULL, 2, NULL, 'j', 16),
(31, '0009-09-09 00:00:00', '0009-09-09 00:00:00', 'p', NULL, 2, NULL, 'j', 16),
(32, '0009-09-09 00:00:00', '0009-09-09 00:00:00', 'p', NULL, 2, NULL, 'j', 16),
(33, '0009-09-09 00:00:00', '0009-09-09 00:00:00', 'p', NULL, 2, NULL, 'j', 16),
(34, '0009-09-09 00:00:00', '0009-09-09 00:00:00', 'p', NULL, 2, NULL, 'j', 16);
...
('DoctrineMigrations\\Version20240610203400', '2024-06-10 22:34:10', 114),
('DoctrineMigrations\\Version20240610210538', '2024-06-10 23:05:48', 27),
('DoctrineMigrations\\Version20240611090858', '2024-06-11 11:09:01', 41),
('DoctrineMigrations\\Version20240611093753', '2024-06-11 11:37:54', 32),
('DoctrineMigrations\\Version20240611170220', '2024-06-11 19:02:29', 36);
...
(2, 'Evento 2', '0002-02-20', '0002-02-20');
...
INSERT INTO `ponente` (`id`, `nombre`, `url`, `cargo`, `ponente_detalle_actividad_id`, `evento_id`) VALUES
(24, '33', '333', '333', NULL, 1),
(25, '44', '444', '444', NULL, 2),
(26, '1', '234', '12', NULL, 1),
(27, '90', '90', '90', NULL, 2),
(28, '7', '7', '7', NULL, 2),
(29, 'h', 'v', 'g', NULL, 1),
(30, 'h', 'h', 'h', NULL, 2),
(31, '233232323223', '232323323232', '2332233232322', NULL, 1),
(32, '56', '6556', '56656', NULL, 1),
(33, 'ujjuujujuuj', 'juujuu', 'jujjuuujuj', NULL, 2),
(34, 'ghgGGHHhg', 'hghghg', 'hghgghhg', NULL, 2),
(35, 'yyyy', 'yyy', 'yyy', NULL, 2),
(36, 'kkk', 'kkk', 'kkkk', NULL, 2),
(37, 'll', 'll', 'lll', NULL, 1),
(38, '2', '22', '22', NULL, 2);
...
ALTER TABLE `ponente`
  ...
  ADD KEY `IDX_969EB3C887A5F842` (`evento_id`);
...
ALTER TABLE `ponente`
  ...
  ADD CONSTRAINT `FK_969EB3C887A5F842` FOREIGN KEY (`evento_id`) REFERENCES `evento` (`id`);
